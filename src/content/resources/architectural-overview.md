...
비교적 순진한 접근 방식이기는 하지만, 이 자동화된 비교는 매우 효과적이어서, 고성능 대화형 앱을 구현할 수 있습니다. 
...
- 부모는 자식의 너비를 지정하지만 자식에게 높이에 대한 유연성을 제공할 수 있습니다. 
  (또는 높이를 지정하지만 너비에 대한 유연성을 제공) 
  실제 사례는, 수평 제약 조건에 맞아야 하지만 텍스트 양에 따라 수직으로 달라야 할 수 있는, 흐름 텍스트입니다.
